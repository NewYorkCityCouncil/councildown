...
For a full demo of the functions in this package, see `vignettes/councildown.Rmd`.
...
-   theme_nycc()
-   scale_fill_nycc() / scale_color_nycc()
...
If you are only using one variable/color, you can add the `"single"` palette using `pal_nycc`.
