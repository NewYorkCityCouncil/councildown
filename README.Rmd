...
Additionally, use `mapshot` to save leaflet maps as a static pdf image. `mapshot()` overwrites `mapview::mapshot()` to force map saves as pdf for increased picture quality and warns users if they choose a different file type. Use `mapview::mapshot` if you want the original `mapshot` function. 
